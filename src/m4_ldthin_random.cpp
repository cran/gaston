...
RcppExport SEXP gg_ld_thin_random(SEXP pASEXP, SEXP muSEXP, SEXP sdSEXP, SEXP thresholdSEXP, SEXP posSEXP, SEXP chrSEXP, SEXP max_distSEXP, SEXP begSEXP, SEXP endSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        LogicalVector __result = ld_thin_random(pA, mu, sd, threshold, pos, chr, max_dist, beg, end);
