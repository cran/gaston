...
List AIREMLn_nofix(NumericVector Y, List K_, int EMsteps, int EMsteps_fail, double EM_alpha, bool constraint, 
                   ...
                   NumericVector theta_, bool start_theta) {
  ...
  AIREMLn_nofix(y, K, EMsteps, EMsteps_fail, EM_alpha, constraint, min_s2, min_tau, max_iter, eps, 
                verbose, theta, logL, logL0, niter, normgrad, Py, omega, start_theta);
...
List AIREMLn_contrast(NumericVector Y, NumericMatrix X, List K_, int EMsteps, int EMsteps_fail, double EM_alpha, bool constraint,
  ...
  AIREMLn_nofix(Cy, CKCt, EMsteps, EMsteps_fail, EM_alpha, constraint, min_s2, min_tau, max_iter, eps, 
                verbose, theta, logL, logL0, niter, normgrad, Py, omega0, start_theta);
...
List AIREMLn(NumericVector Y, NumericMatrix X, List K_, int EMsteps, int EMsteps_fail, double EM_alpha, bool constraint,
  ...
  AIREMLn(y, x, K, EMsteps, EMsteps_fail, EM_alpha, constraint, min_s2, min_tau, max_iter, eps, verbose, theta, logL, logL0, 
            niter, normgrad, Py, omega, beta, varbeta, varXbeta, start_theta);
...
RcppExport SEXP gg_AIREMLn_nofix(SEXP YSEXP, SEXP K_SEXP, SEXP EMstepsSEXP, SEXP EMsteps_failSEXP, SEXP EM_alphaSEXP, SEXP constraintSEXP, SEXP min_s2SEXP, SEXP min_tau_SEXP, SEXP max_iterSEXP, SEXP epsSEXP, SEXP verboseSEXP, SEXP theta_SEXP, SEXP start_thetaSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        List __result = AIREMLn_nofix(Y, K_, EMsteps, EMsteps_fail, EM_alpha, constraint, min_s2, min_tau_, max_iter, eps, verbose, theta_, start_theta);
...
RcppExport SEXP gg_AIREMLn_contrast(SEXP YSEXP, SEXP XSEXP, SEXP K_SEXP, SEXP EMstepsSEXP, SEXP EMsteps_failSEXP, SEXP EM_alphaSEXP, SEXP constraintSEXP, SEXP min_s2SEXP, SEXP min_tau_SEXP, SEXP max_iterSEXP, SEXP epsSEXP, SEXP verboseSEXP, SEXP theta_SEXP, SEXP start_thetaSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::traits::input_parameter< NumericVector >::type theta_(theta_SEXP );
        Rcpp::traits::input_parameter< bool >::type start_theta(start_thetaSEXP );
        List __result = AIREMLn_contrast(Y, X, K_, EMsteps, EMsteps_fail, EM_alpha, constraint, min_s2, min_tau_, max_iter, eps, verbose, theta_, start_theta);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
RcppExport SEXP gg_AIREMLn(SEXP YSEXP, SEXP XSEXP, SEXP K_SEXP, SEXP EMstepsSEXP, SEXP EMsteps_failSEXP, SEXP EM_alphaSEXP, SEXP constraintSEXP, SEXP min_s2SEXP, SEXP min_tau_SEXP, SEXP max_iterSEXP, SEXP epsSEXP, SEXP verboseSEXP, SEXP theta_SEXP, SEXP start_thetaSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::traits::input_parameter< NumericVector >::type theta_(theta_SEXP );
        Rcpp::traits::input_parameter< bool >::type start_theta(start_thetaSEXP );
        List __result = AIREMLn(Y, X, K_, EMsteps, EMsteps_fail, EM_alpha, constraint, min_s2, min_tau_, max_iter, eps, verbose, theta_, start_theta);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
